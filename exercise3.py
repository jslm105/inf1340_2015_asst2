...
def union():
    ...
    Check that cell of row 1, column 1 of table 1 has the same value (in this case a string "Number" but it could be
    anything just so long as they're both the same) as cell of row 1, column 1 of table 2.
